...
#Example
 The code below produces the following plot for Cooper Creek, a highly ephemeral river in western Queensland, Australia. The function uses geom_raster() from the ggplot2 package. Addtional options are available (see ?ctf_raster for details).
```
 library(hydrostats)
 data(Cooper)
 ctf_heatmap(Cooper)
